 ...
 */
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("cpu占有率=" + Test.getCpuRatioForWindows());
        System.out.println("可使用内存=" + Test.getMemery());
        System.out.println("各盘占用情况：" + Test.getDisk());
