...
<a href="javascript:void(history.back())" class="layui-btn" target="_blank"><i class="layui-icon">&#xe65a;</i>返回版块</a>
<br><br>
<blockquote class="layui-elem-quote " style="background-color: #FFFFFF;margin-bottom: 5px"><span>${section.name}·</span>版块下的类型 (<span style="color: red" id="number">${section.sectionCategory.size()}</span>)
